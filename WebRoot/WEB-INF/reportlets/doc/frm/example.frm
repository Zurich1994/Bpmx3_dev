...
<Query>
<![CDATA[SELECT * FROM 订单 where 订单ID=${orderid}]]></Query>
</TableData>
...
<Query>
<![CDATA[select * from 订单明细 where 订单ID=${orderid}]]></Query>
</TableData>
</TableDataMap>
...
<FormulaDictAttr kiName="订单ID" viName="订单ID"/>
<DBDictAttr tableName="订单" schemaName="" ki="-1" vi="-1" kiName="订单ID" viName="订单ID"/>
<Connection class="com.fr.data.impl.NameDatabaseConnection">
<DatabaseName>
<![CDATA[FRDemo]]></DatabaseName>
</Connection>
...
<BoundsAttr x="316" y="25" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<widgetValue>
<databinding>
<![CDATA[{Name:ds1,Key:客户ID}]]></databinding>
</widgetValue>
</InnerWidget>
<BoundsAttr x="396" y="25" width="126" height="21"/>
</Widget>
<Sorted sorted="false"/>
...
<WidgetNameTagMap>
<NameTag name="textEditor0" tag="客户ID："/>
<NameTag name="orderid" tag="orderid:"/>
</WidgetNameTagMap>
</North>
...
<BoundsAttr x="0" y="21" width="864" height="465"/>
</Widget>
