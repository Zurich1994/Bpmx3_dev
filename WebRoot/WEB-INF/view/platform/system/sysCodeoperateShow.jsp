...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#treeReFresh").click(function() {
			loadTree("");
			$("#viewFrame").attr("src","${ctx}/platform/system/sysCodeoperate/detail.ht");
		});
	...
	function loadTree(subject) {
		...
		$.post("${ctx}/platform/system/sysCodeoperate/getTableData.ht?typeId=10000041550186&subject="+subject,
		//10000041550186
			function(result) {
	...
	function zTreeOnCheck(event, treeId, treeNode){
		...
		var url="${ctx}/platform/system/sysCodeoperate/detail.ht?flowName="+encodeURIComponent(flowName)
...
<body>
	<div id="layout" style="bottom: 1; top: 1">
		<div position="left" title="操作图定义管理" id="TreeManage"
		...
		<div position="center" id="tableView" style="height: 100%;">
			...
			<iframe id="viewFrame" src="${ctx}/platform/system/sysCodeoperate/detail.ht" frameborder="0" width="100%"
				height="90%"></iframe>
		</div>
	</div>
</body>
