...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysDataSourceLList" id="sysDataSourceLItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${sysDataSourceLItem.id}">
				</display:column>
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="edit.ht?id=${sysDataSourceLItem.id}" class="link edit">编辑</a>
					<a href="del.ht?id=${sysDataSourceLItem.id}" class="link del">删除</a>
				</display:column>
			</display:table>
			<hotent:paging tableId="sysDataSourceLItem"/>
