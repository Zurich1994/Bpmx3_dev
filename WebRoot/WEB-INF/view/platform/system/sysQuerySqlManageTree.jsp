...
<style type="text/css">
	...
	<script type="text/javascript">
		...
		function onClick(treeNode){
			var url="${ctx}/platform/system/sysQuerySql/list.ht";
...
<body>
   	<div id="defLayout" >
         ...
         <div position="center">
        	<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/system/sysQuerySql/list.ht"></iframe>
         </div>
     </div>
</body>
</html>
