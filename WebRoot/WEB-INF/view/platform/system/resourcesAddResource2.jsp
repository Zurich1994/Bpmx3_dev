			...
			<div class="panel">
					...
					<div class="panel-body">
							<table id="resourcesTable" class="table-detail" cellpadding="0" cellspacing="0" border="0">
									...
									<tr>
										<th width="20%">跳转原子操作编号: </th>
										<td><input type="text" id="redirectionno" name="redirectionno" class="inputText"/></td>
									</tr>
								<tr>
										<th width="20%">默认地址: </th>
										<td><input type="text" id="Url" name="Url" size="60"  class="inputText" value="/redirection/redirection/redirection/addredirection.ht" readonly="readonly"/></td>
									</tr>
									...
									<input type="hidden" id="defaultUrl" name="defaultUrl" size="60"  class="inputText" readonly="readonly" />
							</table>
					</div>
			</div>
			</form>
