...
<html>
    <head>
        ...
        <script type="text/javascript">
        		var catKey="<%=GlobalType.CAT_NETWORKMAP%>";
            	...
            	function onClick( treeNode){
            		...
            		var url="${ctx}/platform/bpm/bpmDefinition/list_b.ht?typeId="+typeId;
    ...
    <body>
      	<div id="defLayout" class="panel-top">
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/bpmDefinition/list_b.ht"></iframe>
            </div>
        </div>
