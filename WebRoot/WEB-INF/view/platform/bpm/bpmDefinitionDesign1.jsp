...
<%
	...
	String postUrl23= basePath + "/platform/bpm/bpmDefinition/flexDefSave23.ht?isAjaxRequest=true";
...
%>
  ...
  <style type="text/css" media="screen"> 
	...
	function getCtxPath23(){
		//ActivityInformWindow({__formId__:"10000020400112",__pk__:"10000020410112"});
		alert(document.getElementById("postUrl23").value);		
		return document.getElementById("postUrl23").value;
	}
 ...
 <textarea id="flagflex" style="display:none"><%=flagflex%></textarea>
  	...
  	<input id="postUrl6" type="hidden" value="<%=postUrl6%>" /> 
  	  	<input id="postUrl23" type="hidden" value="<%=postUrl23%>" /> 
