...
<html>
    <head>
        ...
        <script type="text/javascript">
        		...
        		var globalType=new GlobalType(catKey,"glTypeTree",
        				{
        					...
        					url:'${ctx}/platform/system/globalType/getByCatKey.ht?typeName='+"事务图",
        					expandByDepth:1
        				});
            	...
            	function onClick( treeNode){
            		...
            		var url="${ctx}/platform/bpm/bpmDefinition/list.ht?typeId="+typeId+"&typeName="+"transactionChart";
    ...
    <body>
      	<div id="defLayout" class="panel-top">
            <div position="left" title="事务图分类管理" style="overflow: auto;float:left;width:100%">
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/bpmDefinition/list.ht?typeId=10000006460068&typeName=transactionChart"></iframe>
            </div>
        </div>
