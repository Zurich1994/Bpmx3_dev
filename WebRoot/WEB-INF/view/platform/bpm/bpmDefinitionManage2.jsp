...
<html>
    <head>
        ...
        <script type="text/javascript">
        		...
        		var globalType=new GlobalType(catKey,"glTypeTree",
        				{
        					...
        					url:'${ctx}/platform/system/globalType/getByCatKey.ht?typeName='+'操作图',
        					expandByDepth:1
        				});
            	...
            	function onClick( treeNode){
            		...
            		var url="${ctx}/platform/bpm/bpmDefinition/list.ht?typeId="+typeId+"&typeName="+"operationChart ";
    ...
    <body>
      	<div id="defLayout" class="panel-top">
            <div position="left" title="操作图分类管理" style="overflow: auto;float:left;width:100%">
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/bpmDefinition/list.ht?typeId=10000041550186&typeName=operationChart"></iframe>
           </div>
        </div>
