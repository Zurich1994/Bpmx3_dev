  		 ...
  		 <display:table name="taskOpinionList" id="taskOpinionItem" requestURI="list.ht" sort="external" cellpadding="0" cellspacing="0" class="table-grid">
			...
			<display:column  titleKey="审批意见" >
				...
				<c:if test="${taskOpinionItem.checkStatus==15}">
					<a  href="javascript:;" onclick="return false;" opinionId="${taskOpinionItem.opinionId }" checkStatus="15" >接收人</a>
				</c:if>
				<c:if test="${taskOpinionItem.checkStatus==38 || taskOpinionItem.checkStatus==43}">
					<a  href="javascript:;" onclick="return false;" opinionId="${taskOpinionItem.opinionId }" checkStatus="40" >接收人</a>
				</c:if>
