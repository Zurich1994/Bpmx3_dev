...
<script type="text/javascript" src="${ctx}/js/hotent/platform/form/GlobalType.js"></script>
		...
		<script type="text/javascript" src="${ctx}/js/hotent/platform/form/GlobalType2.js"></script>
        ...
        <script type="text/javascript">
        		...
        		{var globalType=new GlobalType(catKey,"glTypeTree",
        			...
        			{
        			var globalType=new GlobalType2(catKey,"glTypeTree",
       				{
        			onClick:onClick,
        			url:'${ctx}/platform/system/globalType/getByCatKeyForBpm.ht'
        			,expandByDepth:1
                ...
                $(function (){
                	...
                	var url="${ctx}/platform/bpm/bpmDefinition/eventselector.ht?isSingle={0}&validStatus={1}&showAll={2}";
            	...
            	function onClick(treeNode){
            		...
            		var url="${ctx}/platform/bpm/bpmDefinition/eventselector.ht?isSingle={0}&validStatus={1}&showAll={2}&typeId={3}";
