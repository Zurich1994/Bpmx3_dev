					...
					<div class="panel-detail">
						...
						<!-- wyx -->
							<tr>
								...
								<td>
									<select name="varType"  >
										<option value="输入" <c:if test="${bpmDefVar.varType eq '输入'}">selected='selected'</c:if>>输入</option>
										<option value="输出" <c:if test="${bpmDefVar.varType eq '输出'}">selected='selected'</c:if>>输出</option>
									</select>
								</td>
							</tr>
						<!-- wyx -->					
