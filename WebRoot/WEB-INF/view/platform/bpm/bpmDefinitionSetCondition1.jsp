	...
	<div class="panel" >
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<a class="link save" id="btnSearch" onclick="saveCondition()"><span></span>保存</a>
					</div>
						...
						<tr>
							...
							<td>
								<div style="margin: 8px 0; ">
									<a href="javascript:selectScript();" id="btnScript" class="link var" title="常用脚本" >常用脚本</a>
									&nbsp;&nbsp;表单变量:
									...
									<div style="padding: 4px;">
										<c:choose>
											<c:when test="${inNode.isMultiple==true}">
												<a href="javascript:addToTextarea('signResult_${inNode.nodeId}=="pass"');" name="signResult"
													>[${inNode.nodeName}]投票通过</a>
															&nbsp;
													<a href="javascript:addToTextarea('signResult_${inNode.nodeId}=="refuse"');" name="signResult"
													>[${inNode.nodeName}]投票不通过</a>
											</c:when>
											<c:otherwise>
												<a href="javascript:addToTextarea('approvalStatus_${inNode.nodeId}==1');" name="signResult"
													>[${inNode.nodeName}]-通过</a>
														    
															&nbsp;
												<a href="javascript:addToTextarea('approvalStatus_${inNode.nodeId}==2');" name="signResult"
													>[${inNode.nodeName}]-反对</a>
											</c:otherwise>
										</c:choose>
										<ul>
						...
						<c:forEach items="${outcomeNodes}" var="outNode">
							<tr class="taskTr">
								...
								<td>
									...
									<textarea id="${inNode.nodeId}" codemirror="true" mirrorheight="110px" name="condition" rows="3" cols="20" class="inputText">${outNode.condition}</textarea>
								</td>
							</tr>
						</c:forEach>
					</table>
