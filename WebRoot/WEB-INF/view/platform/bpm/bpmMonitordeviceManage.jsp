...
<html>
    <head>
        ...
        //改
            	...
            	//改
            		var url="${ctx}/monitorDevice/monitorDevice/monitorDevice/list_b.ht?typeId="+typeId;
    ...
    <body>
      	<div id="defLayout" class="panel-top">
            <div position="left" title="监控主机分类管理" style="overflow: auto;float:left;width:100%">
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/monitorDevice/monitorDevice/monitorDevice/list_b.ht"></iframe>
            </div>
        </div>
