<%--
	time:2015-04-16 11:05:09
	desc:edit the 原子操作写页面设置页面元素
	author：史欣慧
--%>
...
<head>
	...
	<script type="text/javascript">
	    ...
	    function selectForm(){
			...
			rerurnlist = rerurnlist.toString().substring(6,rerurnlist.toString().length-3);
			dialog.get("finalCall")(rerurnlist);
			dialog.close();
	    }
...
<body>
		<div id="defLayout" >
	            <div position="left" title="获取页面元素列表" style="overflow: scroll;width: 270px;height:450px;">
	            ...
	            <div id="fieldSetting" position="right"  title="页面元素设置">
		          		...
		          		<div class="panel-detail returnContainer">
		          			...
		          			<div style="overflow: auto;">
			          			<table cellpadding="1" class="table-grid table-list" cellspacing="10">
			          				<tr>
			          					<th>
			          						页面元素名
			          					</th>
