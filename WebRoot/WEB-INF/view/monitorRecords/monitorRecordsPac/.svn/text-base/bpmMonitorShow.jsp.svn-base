...
<html>
    <head>
        ...
        //改
        		var catKey="<%=GlobalType.CAT_DEMM%>";
        		...
        		var globalType=new GlobalType(catKey,"glTypeTree",
        				{
        					...
        					url:'${ctx}/extension/monitor/monitor/getMonitorTree.ht',
        					expandByDepth:1
        				});
            	...
            	function onClick( treeNode){
            		if(treeNode.isLeaf==true) {
	            		...
	            		//var url="${ctx}/monitorRecords/monitorRecordsPac/monitorRecords/listByDeviceQuotaRel.ht?deviceQuotaRelId="+typeId; 
	            		var url="${ctx}/monitorRecords/monitorRecordsPac/monitorRecords/list.ht?deviceQuotaRelId="+typeId;           		
    ...
    <body>
      	<div id="defLayout" class="panel-top">
            <div position="left" title="监控管理" style="overflow: auto;float:left;width:100%">
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src=""></iframe>
            </div>
        </div>
