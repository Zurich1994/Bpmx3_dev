	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">防火墙配置表管理列表</span>
			</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="firewallList" id="firewallItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${firewallItem.id}">
				</display:column>
				...
				<display:column property="sb_id" title="设备编号" sortable="true" sortName="F_SB_ID"></display:column>
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.ht?id=${firewallItem.id}" class="link del"><span></span>删除</a>
					<a href="edit.ht?id=${firewallItem.id}" class="link edit"><span></span>编辑</a>
					<a href="get.ht?id=${firewallItem.id}" class="link detail"><span></span>明细</a>
				</display:column>
			</display:table>
			<hotent:paging tableId="firewallItem"/>
