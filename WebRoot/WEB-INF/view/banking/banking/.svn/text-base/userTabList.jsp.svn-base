...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						<span class="label">用户名,由英文及数字组合而成:</span><input type="text" name="Q_USERID_S"  class="inputText" />
						<span class="label">密码:</span><input type="text" name="Q_PASSWORD_S"  class="inputText" />
						<span class="label">地址:</span><input type="text" name="Q_ADDRESS_S"  class="inputText" />
						<span class="label">城市:</span><input type="text" name="Q_CITY_S"  class="inputText" />
						<span class="label">州,2位州代码:</span><input type="text" name="Q_STATE_S"  class="inputText" />
						...
						<span class="label">邮件地址:</span><input type="text" name="Q_EMAIL_S"  class="inputText" />
					</div>
				</form>
			</div>
		</div>
		<div class="panel-body">
		    ...
		    <display:table name="userTabList" id="userTabItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${userTabItem.id}">
				</display:column>
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.ht?id=${userTabItem.id}" class="link del"><span></span>删除</a>
					<a href="edit.ht?id=${userTabItem.id}" class="link edit"><span></span>编辑</a>
					<a href="get.ht?id=${userTabItem.id}" class="link detail"><span></span>明细</a>
				</display:column>
			</display:table>
			<hotent:paging tableId="userTabItem"/>
