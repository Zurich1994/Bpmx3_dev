	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
					    <span class="label">子系统数量:</span><input type="text" name="Q_sysNum_S"  class="inputText" />
						...
						<span class="label">信息资源开发程度:</span><input type="text" name="Q_infoResOpenGrade_S"  class="inputText" />
						...
						<span class="label">流程数量:</span><input type="text" name="Q_defNum_S"  class="inputText" />
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysinfomationList" id="sysinfomationItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column property="sysNum" title="子系统数量" sortable="true" sortName="F_SYSNUM"></display:column>
				...
				<display:column property="sysName" title="信息资源开发程度" sortable="true" sortName="F_INFORESOPENGRADE"></display:column>
				...
				<display:column property="defNum" title="流程数量" sortable="true" sortName="F_DEFNUM"></display:column>
