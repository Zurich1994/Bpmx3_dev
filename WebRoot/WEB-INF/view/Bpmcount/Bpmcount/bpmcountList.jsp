...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmcountList" id="bpmcountItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.ht?id=${bpmcountItem.id}" class="link del"><span></span>删除</a>
					<a href="edit.ht?id=${bpmcountItem.id}" class="link edit"><span></span>编辑</a>
