...
<html>
<head>
<title>业务操作分析-4</title>
<%@include file="/commons/include/get.jsp" %>
</head>
<body>
<iframe id="report" width="1200" height="500" src="http://192.168.3.114:8080/mas/ReportServer?reportlet=业务操作分析表-4.cpt"></iframe>
	<!--<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">业务操作分析-4</span>
			</div>
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<span class="label">作业子系统:</span><input type="text" name="Q_work_subsys_L"  class="inputText" />
						<span class="label">节点编号:</span><input type="text" name="Q_activity_num_L"  class="inputText" />
						<span class="label">操作对象名:</span><input type="text" name="Q_ope_obj_name_S"  class="inputText" />
						<span class="label">信息内容:</span><input type="text" name="Q_info_content_S"  class="inputText" />
		...
		<div class="panel-body">
		    ...
		    <display:table name="activityDetail" id="activityDetailItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column property="ope_obj_name" title="操作对象名" sortable="true" sortName="F_OPE_OBJ_NAME"></display:column>
				<display:column property="info_content" title="信息内容" sortable="true" sortName="F_INFO_CONTENT"></display:column>
