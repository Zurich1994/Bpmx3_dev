    ...
    <div name="div_attachment_container" right="w">
     ...
     <a id="yySelectFile"  href="javascript:;" field="year_year_date" class="link selectFile" atype="select" onclick="{AttachMent.directUpLoadFile(this);}" validate="{}" name="year_year_date">选择</a>
      ...
      <input type="checkbox" name="curveImpot" value="趋势曲线信息录入" />趋势曲线信息录入&nbsp;
       <input id="yyCurveCK" type="checkbox" name="historyCurve" value="查看历史数据曲线" onclick="CurveChecked('yyCurveCK','yyCurveLabel','yyCurveView')" /><label id="yyCurveLabel">查看历史数据曲线</label><a name="year" href="javascript:void(0);"  onclick=""  id="yyCurveView">查看</a>&nbsp;
    </div></td>
  </tr>
  <tr>
   ...
   <td class="formInput" style="width:80%;" right="w">
    <div name="div_attachment_container" right="w">
     ...
     <input type="checkbox" name="curveImpot" value="趋势曲线信息录入" />趋势曲线信息录入&nbsp;
     <input id="ymCurveCK" type="checkbox" name="historyCurve" value="查看历史数据曲线" onclick="CurveChecked('ymCurveCK','ymCurveLabel','ymCurveView')"/><label id="ymCurveLabel">查看历史数据曲线</label><a name="month" href="javascript:void(0);"  onclick=""  id="ymCurveView">查看</a>&nbsp;
    </div></td>
  </tr>
  <tr>
   ...
   <td class="formInput" style="width:80%;" right="w">
    <div name="div_attachment_container" right="w">
     ...
     <input type="checkbox" name="curveImpot" value="趋势曲线信息录入" />趋势曲线信息录入&nbsp;
     <input id="mdCurveCK" type="checkbox" name="historyCurve" value="查看历史数据曲线" onclick="CurveChecked('mdCurveCK','mdCurveLabel','mdCurveView')"/><label id="mdCurveLabel">查看历史数据曲线</label><a name="day" href="javascript:void(0);"  onclick=""  id="mdCurveView">查看</a>&nbsp;
    </div></td>
  </tr>
  <tr>
   ...
   <td class="formInput" style="width:80%;" right="w">
    <div name="div_attachment_container" right="w">
     ...
     <input type="checkbox" name="curveImpot" value="趋势曲线信息录入" />趋势曲线信息录入&nbsp;
     <input id="dhCurveCK" type="checkbox" name="historyCurve" value="查看历史数据曲线" onclick="CurveChecked('dhCurveCK','dhCurveLabel','dhCurveView')" /><label id="dhCurveLabel">查看历史数据曲线</label><a name="hour" href="javascript:void(0);"  onclick=""  id="dhCurveView">查看</a>&nbsp;
    </div></td>
  </tr>
  <tr>
   ...
   <td class="formInput" style="width:80%;" right="w">
    <div name="div_attachment_container" right="w">
     ...
     <input type="checkbox" name="curveImpot" value="趋势曲线信息录入" />趋势曲线信息录入&nbsp;
     <input id="hmCurveCK" type="checkbox" name="historyCurve" value="查看历史数据曲线" onclick="CurveChecked('hmCurveCK','hmCurveLabel','hmCurveView')" /><label id="hmCurveLabel">查看历史数据曲线</label><a name="minute" href="javascript:void(0);"  onclick=""  id="hmCurveView">查看</a>&nbsp;
    </div></td>
  </tr>
 </tbody>
</table>
