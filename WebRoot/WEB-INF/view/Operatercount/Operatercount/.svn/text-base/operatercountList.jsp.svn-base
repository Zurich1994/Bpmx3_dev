...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="operatercountList" id="operatercountItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					...
					<a href="edit.ht?id=${operatercountItem.id}" class="link edit"><span></span>编辑</a>
					<a href="get.ht?id=${operatercountItem.id}" class="link detail"><span></span>明细</a>
				</display:column>
			</display:table>
