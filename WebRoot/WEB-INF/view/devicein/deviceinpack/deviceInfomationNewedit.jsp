...
<div class="panel">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td class="formInput" style="width:80%"><input  height="200" width="125" name="dev_type" validate="{empty:false}" nodekey="shebeileixing" lablename="设备类型" readonly="readonly" value="${deviceInfomation.dev_type}" /></td>
  </tr>
  <tr>
