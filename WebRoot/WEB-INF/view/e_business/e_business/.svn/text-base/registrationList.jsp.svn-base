...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="registrationList" id="registrationItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${registrationItem.id}">
				</display:column>
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.ht?id=${registrationItem.id}" class="link del"><span></span>删除</a>
					<a href="edit.ht?id=${registrationItem.id}" class="link edit"><span></span>编辑</a>
					<a href="get.ht?id=${registrationItem.id}" class="link detail"><span></span>明细</a>
				</display:column>
			</display:table>
			<hotent:paging tableId="registrationItem"/>
