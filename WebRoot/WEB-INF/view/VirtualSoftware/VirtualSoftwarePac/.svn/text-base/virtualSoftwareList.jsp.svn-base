	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">虚拟机-软件表管理列表</span>
			</div>
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						<span class="label">虚拟机编号:</span><input type="text" name="Q_virtual_ID_S"  class="inputText" />
		...
		<div class="panel-body">
		    ...
		    <display:table name="virtualSoftwareList" id="virtualSoftwareItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${virtualSoftwareItem.id}">
				</display:column>
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.ht?id=${virtualSoftwareItem.id}" class="link del"><span></span>删除</a>
					<a href="edit.ht?id=${virtualSoftwareItem.id}" class="link edit"><span></span>编辑</a>
					<a href="get.ht?id=${virtualSoftwareItem.id}" class="link detail"><span></span>明细</a>
				</display:column>
			</display:table>
			<hotent:paging tableId="virtualSoftwareItem"/>
