	...
	<body>
		...
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">添加定时计划</span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link save" id="dataFormSave" href="javascript:;"><span></span>保存</a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link back" href="${ctx}/monitorDevice/monitorDevice/monitorDevice/list_b.ht"><span></span>返回</a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
				<form id="dataForm" method="post" action="allMonitorAdd.ht">
