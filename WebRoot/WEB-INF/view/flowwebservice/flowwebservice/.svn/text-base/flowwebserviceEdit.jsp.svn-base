...
<div class="panel">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td style="width:80%" class="formInput"><input name="defid" validate="{number:true,maxIntLen:18,maxDecimalLen:0}" showtype="{'coinValue':'','isShowComdify':0,'decimalValue':0}" value="${defid}" readonly="readonly" /></td>
  </tr>
 </tbody>
</table>
			</div>
