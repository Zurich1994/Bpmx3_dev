							...
							<tbody>
								<c:forEach items="${processRunDataList}" var="processRunData" varStatus="status">
									...
									<tr class="${clsName}">
										...
										<td>
												<a name="processDetail" onclick="showDetail(this)" href="#${processRunData.runId}"  action="info.ht?prePage=completedMatter&link=1&runId=${processRunData.runId}" title='${processRunData.subject}' >${processRunData.subject}</a>
										</td>
										<td>
