	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="completedMattersListWithBus.ht">
							<ul class="row">
							<li>
		...
		<div class="panel-body">
			    ...
			    <display:table name="processRunList" id="processRunItem" requestURI="completedMattersListWithBus.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<hrbeu:paging tableId="processRunItem"/>
