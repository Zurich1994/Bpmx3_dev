...
<div class="panel">
 ...
 <tbody>
  ...
  <tr>
   ...
   <input class="inputText" name="dev_Port" validate="{maxlength:50,required:true}" 
   		lablename="设备端口" isflag="tableflag" value="${devicerelationship.dev_Port}"/></span></td>
  </tr>
  <tr>
   <td class="formTitle" style="width:20%" nowrap="nowrap" align="right">对端设备编号:</td>
   <td class="formInput" style="width:80%">
   <input height="200" width="125" name="opp_ID" lablename="对端设备编号" value="${f_opp_id}"  /></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td class="formInput" style="width:80%">
   <input lablename="流程定义id" name="actdefid" height="200" width="125"  readonly="readonly" value="${actDefId}" /></td>
  </tr>
 </tbody>
</table>
			</div>
