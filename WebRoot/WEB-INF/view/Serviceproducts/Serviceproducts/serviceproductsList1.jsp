	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list1.ht">
					<div class="row">
		...
		<div class="panel-body">
		    ...
		    <display:table name="serviceproductsList" id="serviceproductsItem" requestURI="list1.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					...
					<a href="edit.ht?id=${serviceproductsItem.id}&serviceId=${serviceproductsItem.serviceID}" class="link edit"><span></span>编辑</a>
