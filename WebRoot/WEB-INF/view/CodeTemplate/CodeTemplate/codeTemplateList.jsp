...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="codeTemplateList" id="codeTemplateItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					...
					<a href="edit.ht?id=${codeTemplateItem.id}" class="link edit"><span></span>编辑</a>
					<a href="get.ht?id=${codeTemplateItem.id}" class="link detail"><span></span>明细</a>
				</display:column>
			</display:table>
