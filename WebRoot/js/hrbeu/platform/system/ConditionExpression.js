Namespace.register("com.hrbeu.platform.system");
/**
 * 表达式计算。
 * var con=com.hrbeu.platform.system.ConditionExpression();
 * 计算节点
 * con.evaluate(node);
 * 获取结果
 * con.getResult();
 * 清除计算
 * con.clear();
 * @returns {com.hrbeu.platform.system.ConditionExpression}
 */
com.hrbeu.platform.system.ConditionExpression = function(){
	{
