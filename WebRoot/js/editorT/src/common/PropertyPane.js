!function (Q) {
    ...
    var nodeProperties = [{name: 'bpmNodeId', type: 'string', displayName: '节点Id',readonly:'readonly' }, 
                          {name: 'defId', type: 'string', displayName: 'defId',readonly:'readonly' },
                          {name: 'subDefKey', type: 'string', displayName: 'subDefKey',readonly:'readonly' },
                          {client: 'property', type: 'string', displayName: 'property',readonly:'readonly' }
//    {
