...
<link rel="stylesheet" type="text/css" href="../shiwutu.css">
...
<script type="text/javascript">
	...
	dialog.onok = function() {
		var html = '<span name="editable-shiwutu" style="display:inline-block;">';
		...
		if(_element){
         ...
         var url =__ctx + "/platform/bpm/bpmDefinition/sherlock.ht";
					$.post(url,{buttonname:label},function(){
					
					});	
					
	//	window.open("http://localhost:8080/mas/js/ueditor2/dialogs/extend/mydialog/definition_manager.jsp");
	};
</script>
</head>
<body>
