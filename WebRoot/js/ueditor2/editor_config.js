       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                'pagebreak', '|','horizontal', 'spechars', '|','inserttable', 'deletetable', 
                ...
                '|','pasteinput','tableformat','choosetemplate','opinion','wordtemplate', '|','taskopinion','flowchart',
                'insertfunction','cutsubtable','pastesubtable','customquery','uncustomquery','numbervalidate','shiwutu',
                '|','myevent','input','addframelist','insertframe','mymap','link','hidedomain','textinput','textarea','checkbox','radioinput','selectinput',
                	'datepicker','music','movies','insertvideo','|','importform','exportform']
        ]
