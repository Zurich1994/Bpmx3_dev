    ...
    EditorUI.prototype = {
        ...
        initEditorUI:function () {
            ...
            var popup = new baidu.editor.ui.Popup({
                ...
                //查看事件属性    魏嫚
                _onEventAttributeClick:function(){
                	this.hide();
                	var child=popup.anchorEl.childNodes[0];
                	if(child){
            			editor.curInput=child;
        	    		editor.execCommand("eventattribute");
                	}
                },
                //11 扩展
                //绑定事物图
                 _onshiwutuButtonClick:function(){
                  	...
                  	if(child){
                	        ...
                	        editor.curInput=child;
           	    		editor.execCommand("transactiongraph");
                       	
                  	}
                  },
                  //12
                  _onInputEditaddframelist:function(){
                  	...
                  	if(child){
                	        ...
                	        editor.curInput=child;
           	    		editor.execCommand("addframelist");
                       	
                  	}
                  	
                  },
                  _onInputEditmymap:function(){
            ...
            if (editor.options.imagePopup) {
                editor.addListener('mouseover', function (t, evt) {
    	    		...
    	    		var addframelist =  el.parentElement.getAttribute("name")=="link-frame";  
    	    		var mymap =  el.parentElement.getAttribute("name")=="link-frame"; 
    	    		var shiwutu = el.parentElement.getAttribute("name")=="editable-shiwutu";   
    	    		var ifElParent = el.parentElement.getAttribute("name") =="editable-input"||el.parentElement.getAttribute("name")=="link-frame"||el.parentElement.getAttribute("name")=="editable-shiwutu" ;
    	    		...
    	    		if(ifEl||ifElParent){
    	    			if(readOnly){
    	    				if(isflag){
		                       ...
		                       '<span onclick="$$._onEventAttributeClick(event, this);" class="edui-clickable">事件属性</span>&nbsp;&nbsp;'+
    				   ...
    				   if(shiwutu){   		
        				   alert("shiwutuzaizhe");
  	    				  html = popup.formatHtml(
  	    	                    ...
  	    	                    '<span onclick="$$._onInputCutButtonClick(event, this);" class="edui-clickable">剪切</span>&nbsp;&nbsp;'+
  	    	                  '<span onclick="$$._onEventAttributeClick(event, this);" class="edui-clickable">事件属性</span>&nbsp;&nbsp;'+
  	    	                    '<span onclick="$$._onshiwutuButtonClick(event, this);" class="edui-clickable">'+editor.getLang("transactiongraph.self")+'</span>' +
  	    	                       '</nobr>' );
  				       } 				
         			   ...
         			   if(addframelist){   		
   	    				  ...
   	    				  html = popup.formatHtml(
   	    	                    '<nobr>'+editor.getLang("property")+': <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">'+editor.getLang("delete")+'</span>&nbsp;&nbsp;' +	                       
   	    	                    '<span onclick="$$._onInputEditaddframelist(event, this);" class="edui-clickable">' + editor.getLang("transactiongraph.self") + '</span>&nbsp;&nbsp;'+
   	    	                    '<span onclick="$$._onInputCutButtonClick(event, this);" class="edui-clickable">剪切</span>&nbsp;&nbsp;'+
   	    	                 '<span onclick="$$._onEventAttributeClick(event, this);" class="edui-clickable">事件属性</span>&nbsp;&nbsp;'+
   	    	                       '</nobr>' );
   				       }
