  ...
  */  var $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    function Chosen(elmn) {
      ...
      this.has_search=$(this.form_field).attr("hasSearch");
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>');
    	  ...
    	  if(this.has_search&&!/^(0|false)$/gi.test(this.has_search))
    		  container_div.html('<a href="javascript:void(0)" class="chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
    	  else{
    		  container_div.html('<a href="javascript:void(0)" class="chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search" style="width:0;height:0;padding:5px 0 0 0;"><input type="text" style="border:none;" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
		  }
      }
