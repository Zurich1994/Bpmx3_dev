...
jQuery.validator.addMethod("compStartEndTime",function(a,b,c){ if(c.substring(1,4)=='END'||c.substring(1,4)=='end'){return daysBetween(a,$(c).attr('value'));}else{return daysBetween($(c).attr('value'),a);} },"");