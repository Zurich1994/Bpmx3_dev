 ...
 * generated in the com.hotent.core.bpmn.entity.omgdc package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hotent.core.bpmn.entity.omgdc
     * 
     */
