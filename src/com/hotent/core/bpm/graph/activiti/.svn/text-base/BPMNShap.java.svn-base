...
public class BPMNShap {
	...
	public String toString() {
		return "BPMNShap [bpmnElement=" + bpmnElement
				+ ", choreographyActivityShape=" + choreographyActivityShape
				+ ", height=" + height + ", isExpanded=" + isExpanded
				+ ", isHorizontal=" + isHorizontal + ", isMarkerVisible="
				+ isMarkerVisible + ", isMessageVisible=" + isMessageVisible
				+ ", name=" + name + ", participantBandKind="
				+ participantBandKind + ", properties=" + properties
				+ ", type=" + type + ", width=" + width + ", x=" + x + ", y="
				+ y + "]";
	}
