...
package com.hotent.serviceSet.dao.serviceSet;
...
@Repository
public class DeviceServerDao extends BaseDao<DeviceServer>
{
	@Override
	...
	public List<DeviceServer> getByNodeIdANDActdefId(String actdefID,String nodeID){
		...
		List<DeviceServer> list = getBySqlKey("getByNodeIdANDActdefId", params);
	...
	public List<Map<String,Object>> getAllRecord(){
		...
		String sql="select F_manage_IP,ID from W_DEVICE_SERVER";
