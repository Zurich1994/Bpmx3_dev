...
import com.hotent.e_business.dao.e_business.ConfirmationDao;
import com.hotent.core.util.UniqueIdUtil;


@Service
public class ConfirmationService extends BaseService<Confirmation>
{
	@Resource
	...
	@Override
	protected IEntityDao<Confirmation,Long> getEntityDao() 
	{
		return dao;
	}
