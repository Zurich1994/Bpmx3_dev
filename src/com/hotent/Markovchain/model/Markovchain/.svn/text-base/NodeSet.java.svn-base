...
public class NodeSet {
	...
	public NodeSet(String nodeId, String label,int num) {
		super();
		this.nodeId = nodeId;
		this.label =label;
		this.num=num;
	...
	public NodeSet(Long defId,String nodeId, String nodeName, String nodeType, List<NodeSet> nextNode, List<NodeSet> preNode,int num) {
		super();
		this.nodeId = nodeId;
		this.nodeName = nodeName;
		this.nodeType = nodeType;
